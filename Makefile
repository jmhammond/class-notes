...
tex:
	xsltproc --xinclude --stringparam exercise.divisional.solution no --stringparam example.divisional.solution no $(STYLESHEETS_DIR)/mathbook-latex.xsl class-notes.xml
